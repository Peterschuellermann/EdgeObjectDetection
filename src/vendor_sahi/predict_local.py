...
# src/vendor_sahi/predict_local.py

from sahi.predict import get_sliced_prediction as _sahi_get_sliced_prediction  # optional, for fallback

# REMOVE this import, not needed anymore:
# from sahi.predict import get_sliced_prediction as _sahi_get_sliced_prediction

def get_sliced_prediction_local(
    image,
    ...
    **kwargs,
    ...
    """
    Wrapper that calls the LOCAL get_sliced_prediction in this file,
    so we can freely modify & optimize it.
    """
